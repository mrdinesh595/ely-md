...
let handler = async (m, { conn }) => {
	...
	if (!canLevelUp(user.level, user.exp, global.multiplier)) {
		...
		try {
			...
			let pp = await conn.profilePictureUrl(m.sender, 'image').catch(_ => 'https://raw.githubusercontent.com/arasea2/elydb/main/ely/media/avatar_contact.jpg')
			let meh = padLead(ranNumb(43), 3)
			let bg = `https://raw.githubusercontent.com/arasea2/elydb/main/ely/media/picbot/menus/menus_${meh}.jpg`
