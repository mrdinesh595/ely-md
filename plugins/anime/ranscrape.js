...
let handler = async (m, { conn, text, usedPrefix, command }) => {
	try {
		...
		} else await conn.sendMsg(m.chat, { image: { url: anu }, caption: `_Random pic : ${command}_` }, { quoted: m })    // await conn.sendButton(m.chat, `_Random pic : ${command}_`, pauthor, anu, [[command, usedPrefix+command]], m)
	} catch (e) {
		console.log(e)
