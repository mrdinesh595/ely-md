...
async function addExif(webpSticker, packname, author, categories = [], extra = {}) {
	...
	const json = { 'sticker-pack-id': stickerPackId, 'sticker-pack-name': packname, 'sticker-pack-publisher': author, 'emojis': categories, 'link-group-bot': 'https://www.instagram.com/pandu.3_?igsh=MWdzbGFidXlsZzF0cA==', 'link-script-github': 'https://github.com/arasea2/ely-md', ...extra };
